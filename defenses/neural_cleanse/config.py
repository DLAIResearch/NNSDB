...
def get_argument():
    ...
    parser.add_argument("--atk_succ_threshold", type=float, default=99)
    parser.add_argument("--early_stop", type=bool, default=True)
    parser.add_argument("--early_stop_threshold", type=float, default=99)
    parser.add_argument("--early_stop_patience", type=int, default=20)
    parser.add_argument("--patience", type=int, default=3)
    parser.add_argument("--cost_multiplier", type=float, default=25)
    ...
    parser.add_argument("--n_times_test", type=int, default=2)
